...
import { ADD_TO_CART, selectSelectedClient } from '../../redux/features/cartSlice';
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginTop: '4px' }}>
          ...
          <div style={{
            ...
            <button
              ...
              aria-label={`Restar unidad, cantidad actual ${qty}`}
              style={{
            ...
            <button
              ...
              aria-label={`Sumar unidad, cantidad actual ${qty}`}
              style={{
                width: '40px', height: '40px', background: 'transparent', border: 'none',
                color: 'var(--text-muted)', cursor: 'pointer', display: 'flex',
                alignItems: 'center', justifyContent: 'center', transition: 'color 0.15s',
